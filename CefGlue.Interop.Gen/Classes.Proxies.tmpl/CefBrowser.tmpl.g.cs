...
namespace Xilium.CefGlue
{
    ...
    public sealed unsafe partial class CefBrowser
    {
        ...
        /// </summary>
        public cef_frame_t* GetFrame(long identifier)
        {
            throw new NotImplementedException(); // TODO: CefBrowser.GetFrame
        }
        
        /// <summary>
        /// Returns the frame with the specified name, or NULL if not found.
        /// </summary>
        public cef_frame_t* GetFrame(cef_string_t* name)
        {
            throw new NotImplementedException(); // TODO: CefBrowser.GetFrame
        }
        ...
        /// </summary>
        public void GetFrameIdentifiers(UIntPtr* identifiersCount, long* identifiers)
        {
