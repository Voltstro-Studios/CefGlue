...
namespace Xilium.CefGlue
{
    ...
    public abstract unsafe partial class CefDevToolsMessageObserver
    {
        ...
        {
            CheckSelf(self);
            throw new NotImplementedException(); // TODO: CefDevToolsMessageObserver.OnDevToolsMessage
        }
        ...
        /// </summary>
        // protected abstract int OnDevToolsMessage(cef_browser_t* browser, void* message, UIntPtr message_size);
        ...
        {
            CheckSelf(self);
            throw new NotImplementedException(); // TODO: CefDevToolsMessageObserver.OnDevToolsMethodResult
        }
        ...
        /// </summary>
        // protected abstract void OnDevToolsMethodResult(cef_browser_t* browser, int message_id, int success, void* result, UIntPtr result_size);
        ...
        {
            CheckSelf(self);
            throw new NotImplementedException(); // TODO: CefDevToolsMessageObserver.OnDevToolsEvent
        }
        ...
        /// </summary>
        // protected abstract void OnDevToolsEvent(cef_browser_t* browser, cef_string_t* method, void* @params, UIntPtr params_size);
        
        private void on_dev_tools_agent_attached(cef_dev_tools_message_observer_t* self, cef_browser_t* browser)
        {
            CheckSelf(self);
            throw new NotImplementedException(); // TODO: CefDevToolsMessageObserver.OnDevToolsAgentAttached
        }
        ...
        /// </summary>
        // protected abstract void OnDevToolsAgentAttached(cef_browser_t* browser);
        
        private void on_dev_tools_agent_detached(cef_dev_tools_message_observer_t* self, cef_browser_t* browser)
        {
            CheckSelf(self);
            throw new NotImplementedException(); // TODO: CefDevToolsMessageObserver.OnDevToolsAgentDetached
        }
        ...
        /// </summary>
        // protected abstract void OnDevToolsAgentDetached(cef_browser_t* browser);
