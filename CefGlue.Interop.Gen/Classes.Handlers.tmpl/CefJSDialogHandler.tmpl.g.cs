...
namespace Xilium.CefGlue
{
    ...
    public abstract unsafe partial class CefJSDialogHandler
    {
        ...
        /// </summary>
        // protected abstract int OnJSDialog(cef_browser_t* browser, cef_string_t* origin_url, CefJSDialogType dialog_type, cef_string_t* message_text, cef_string_t* default_prompt_text, cef_jsdialog_callback_t* callback, int* suppress_message);
