...
namespace Xilium.CefGlue
{
    ...
    public abstract unsafe partial class CefFrameHandler
    {
        ...
        {
            CheckSelf(self);
            throw new NotImplementedException(); // TODO: CefFrameHandler.OnFrameCreated
        }
        ...
        /// </summary>
        // protected abstract void OnFrameCreated(cef_browser_t* browser, cef_frame_t* frame);
        
        private void on_frame_attached(cef_frame_handler_t* self, cef_browser_t* browser, cef_frame_t* frame, int reattached)
        {
            CheckSelf(self);
            throw new NotImplementedException(); // TODO: CefFrameHandler.OnFrameAttached
        }
        ...
        /// been dispatched.
        /// </summary>
        // protected abstract void OnFrameAttached(cef_browser_t* browser, cef_frame_t* frame, int reattached);
        
        private void on_frame_detached(cef_frame_handler_t* self, cef_browser_t* browser, cef_frame_t* frame)
        {
            CheckSelf(self);
            throw new NotImplementedException(); // TODO: CefFrameHandler.OnFrameDetached
        }
        ...
        /// </summary>
        // protected abstract void OnFrameDetached(cef_browser_t* browser, cef_frame_t* frame);
        ...
        {
            CheckSelf(self);
            throw new NotImplementedException(); // TODO: CefFrameHandler.OnMainFrameChanged
        }
        ...
        /// CefBrowser::IsValid() will return false for |browser|.
        /// </summary>
        // protected abstract void OnMainFrameChanged(cef_browser_t* browser, cef_frame_t* old_frame, cef_frame_t* new_frame);
