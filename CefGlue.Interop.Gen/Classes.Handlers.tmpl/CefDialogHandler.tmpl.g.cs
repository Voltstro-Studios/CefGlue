...
namespace Xilium.CefGlue
{
    ...
    public abstract unsafe partial class CefDialogHandler
    {
        ...
        {
            CheckSelf(self);
            throw new NotImplementedException(); // TODO: CefDialogHandler.OnFileDialog
        }
        ...
        /// </summary>
        // protected abstract int OnFileDialog(cef_browser_t* browser, CefFileDialogMode mode, cef_string_t* title, cef_string_t* default_file_path, cef_string_list* accept_filters, int selected_accept_filter, cef_file_dialog_callback_t* callback);
