...
namespace Xilium.CefGlue
{
    ...
    public abstract unsafe partial class CefRequestContextHandler
    {
        ...
        {
            CheckSelf(self);
            throw new NotImplementedException(); // TODO: CefRequestContextHandler.OnRequestContextInitialized
        }
        ...
        /// </summary>
        // protected abstract void OnRequestContextInitialized(cef_request_context_t* request_context);
        ...
        {
            CheckSelf(self);
            throw new NotImplementedException(); // TODO: CefRequestContextHandler.OnBeforePluginLoad
        }
        ...
        /// </summary>
        // protected abstract int OnBeforePluginLoad(cef_string_t* mime_type, cef_string_t* plugin_url, int is_main_frame, cef_string_t* top_origin_url, cef_web_plugin_info_t* plugin_info, CefPluginPolicy* plugin_policy);
        ...
        {
            CheckSelf(self);
            throw new NotImplementedException(); // TODO: CefRequestContextHandler.GetResourceRequestHandler
        }
