...
namespace Xilium.CefGlue
{
    ...
    public abstract unsafe partial class CefLifeSpanHandler
    {
        ...
        /// </summary>
        // protected abstract int OnBeforePopup(cef_browser_t* browser, cef_frame_t* frame, cef_string_t* target_url, cef_string_t* target_frame_name, CefWindowOpenDisposition target_disposition, int user_gesture, cef_popup_features_t* popupFeatures, cef_window_info_t* windowInfo, cef_client_t** client, cef_browser_settings_t* settings, cef_dictionary_value_t** extra_info, int* no_javascript_access);
        
        private void on_after_created(cef_life_span_handler_t* self, cef_browser_t* browser)
        {
            CheckSelf(self);
            throw new NotImplementedException(); // TODO: CefLifeSpanHandler.OnAfterCreated
        }
        ...
        /// </summary>
        // protected abstract void OnAfterCreated(cef_browser_t* browser);
        
        private int do_close(cef_life_span_handler_t* self, cef_browser_t* browser)
        {
            CheckSelf(self);
            throw new NotImplementedException(); // TODO: CefLifeSpanHandler.DoClose
        }
        ...
        /// exist.
        /// </summary>
        // protected abstract int DoClose(cef_browser_t* browser);
        
        private void on_before_close(cef_life_span_handler_t* self, cef_browser_t* browser)
        {
            CheckSelf(self);
            throw new NotImplementedException(); // TODO: CefLifeSpanHandler.OnBeforeClose
        }
        ...
        /// </summary>
        // protected abstract void OnBeforeClose(cef_browser_t* browser);
