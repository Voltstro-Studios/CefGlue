...
namespace Xilium.CefGlue
{
    ...
    public abstract unsafe partial class CefMediaSinkDeviceInfoCallback
    {
        ...
        {
            CheckSelf(self);
            throw new NotImplementedException(); // TODO: CefMediaSinkDeviceInfoCallback.OnMediaSinkDeviceInfo
        }
        ...
        /// retrieved.
        /// </summary>
        // protected abstract void OnMediaSinkDeviceInfo(cef_media_sink_device_info_t* device_info);
