...
namespace Xilium.CefGlue.Interop
{
    ...
    internal unsafe struct cef_display_handler_t
    {
        ...
        internal IntPtr _on_contents_bounds_change;
        internal IntPtr _get_root_window_screen_rect;
        ...
        [SuppressUnmanagedCodeSecurity]
        #endif
        internal delegate int on_contents_bounds_change_delegate(cef_display_handler_t* self, cef_browser_t* browser, cef_rect_t* new_bounds);
        
        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
        #if !DEBUG
        [SuppressUnmanagedCodeSecurity]
        #endif
        internal delegate int get_root_window_screen_rect_delegate(cef_display_handler_t* self, cef_browser_t* browser, cef_rect_t* rect);
