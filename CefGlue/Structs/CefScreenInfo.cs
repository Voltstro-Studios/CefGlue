...
public sealed unsafe class CefScreenInfo
{
    ...
    public CefRectangle Rectangle
    {
        ...
        set => _self->rect = new cef_rect_t(value.X, value.Y, value.Width, value.Height);
    }
    ...
    public CefRectangle AvailableRectangle
    {
        ...
        set => _self->available_rect = new cef_rect_t(value.X, value.Y, value.Width, value.Height);
    }
