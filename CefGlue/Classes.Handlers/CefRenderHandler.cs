...
public abstract unsafe partial class CefRenderHandler
{
    ...
    private int get_screen_point(cef_render_handler_t* self, cef_browser_t* browser, int viewX, int viewY, int* screenX,
        int* screenY)
    {
        CheckSelf(self);
    ...
    ///     is set to false.
    /// </summary>
    protected abstract void OnPaint(CefBrowser browser, CefPaintElementType type, CefRectangle[] dirtyRects,
    ...
    private void on_accelerated_paint(cef_render_handler_t* self, cef_browser_t* browser, CefPaintElementType type,
        UIntPtr dirtyRectsCount, cef_rect_t* dirtyRects, void* shared_handle)
    {
        CheckSelf(self);
    ...
    /// </summary>
    protected abstract void OnAcceleratedPaint(CefBrowser browser, CefPaintElementType type, CefRectangle[] dirtyRects,
        IntPtr sharedHandle);
    ...
    ///     operation has ended.
    /// </summary>
    protected virtual bool StartDragging(CefBrowser browser, CefDragData dragData, CefDragOperationsMask allowedOps,
        int x, int y)
    {
        return false;
    }
    ...
    private void on_ime_composition_range_changed(cef_render_handler_t* self, cef_browser_t* browser,
        cef_range_t* selected_range, UIntPtr character_boundsCount, cef_rect_t* character_bounds)
    {
        ...
        {
            var m_characterBoundsCount = (int) character_boundsCount;
    ...
    /// </summary>
    protected abstract void OnImeCompositionRangeChanged(CefBrowser browser, CefRange selectedRange,
        CefRectangle[] characterBounds);


    private void on_text_selection_changed(cef_render_handler_t* self, cef_browser_t* browser,
    ...
    private void on_virtual_keyboard_requested(cef_render_handler_t* self, cef_browser_t* browser,
