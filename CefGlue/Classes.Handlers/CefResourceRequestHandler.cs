...
{
    private cef_cookie_access_filter_t* get_cookie_access_filter(cef_resource_request_handler_t* self,
    ...
    /// </summary>
    protected abstract CefCookieAccessFilter? GetCookieAccessFilter(CefBrowser? browser, CefFrame? frame,
        CefRequest request);


    private CefReturnValue on_before_resource_load(cef_resource_request_handler_t* self, cef_browser_t* browser,
    ...
    /// </summary>
    protected virtual CefReturnValue OnBeforeResourceLoad(CefBrowser? browser, CefFrame? frame, CefRequest request,
    ...
    private cef_resource_handler_t* get_resource_handler(cef_resource_request_handler_t* self, cef_browser_t* browser,
    ...
    private void on_resource_redirect(cef_resource_request_handler_t* self, cef_browser_t* browser, cef_frame_t* frame,
        cef_request_t* request, cef_response_t* response, cef_string_t* new_url)
    {
        CheckSelf(self);
        ...
        if (m_newUrl != o_newUrl) cef_string_t.Copy(m_newUrl, new_url);
    }
    ...
    ///     in this callback.
    /// </summary>
    protected virtual void OnResourceRedirect(CefBrowser? browser, CefFrame? frame, CefRequest request,
        CefResponse response, ref string? newUrl)
    {
    }


    private int on_resource_response(cef_resource_request_handler_t* self, cef_browser_t* browser, cef_frame_t* frame,
    ...
    /// </summary>
    protected virtual bool OnResourceResponse(CefBrowser? browser, CefFrame? frame, CefRequest request,
    ...
    private cef_response_filter_t* get_resource_response_filter(cef_resource_request_handler_t* self,
        cef_browser_t* browser, cef_frame_t* frame, cef_request_t* request, cef_response_t* response)
    {
        ...
        if (result != null) return result.ToNative();
    ...
    /// </summary>
    protected virtual CefResponseFilter? GetResourceResponseFilter(CefBrowser? browser, CefFrame? frame,
    ...
    private void on_resource_load_complete(cef_resource_request_handler_t* self, cef_browser_t* browser,
    ...
    private void on_protocol_execution(cef_resource_request_handler_t* self, cef_browser_t* browser, cef_frame_t* frame,
    ...
    /// </summary>
    protected virtual void OnProtocolExecution(CefBrowser? browser, CefFrame? frame, CefRequest request,
        ref bool allowOSExecution)
    {
    }
}