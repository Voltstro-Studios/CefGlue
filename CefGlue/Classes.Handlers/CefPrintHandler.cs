...
public abstract unsafe partial class CefPrintHandler
{
    ...
    private void on_print_settings(cef_print_handler_t* self, cef_browser_t* browser, cef_print_settings_t* settings,
        int get_defaults)
    {
        CheckSelf(self);
    ...
    private int on_print_dialog(cef_print_handler_t* self, cef_browser_t* browser, int has_selection,
    ...
    private int on_print_job(cef_print_handler_t* self, cef_browser_t* browser, cef_string_t* document_name,
        cef_string_t* pdf_file_path, cef_print_job_callback_t* callback)
    {
        CheckSelf(self);
    ...
    ///     immediately.
    /// </summary>
    protected abstract bool OnPrintJob(CefBrowser browser, string? documentName, string? pdfFilePath,
