...
public abstract unsafe partial class CefResourceHandler
{
    ...
    private int open(cef_resource_handler_t* self, cef_request_t* request, int* handle_request,
...
#pragma warning restore CS0618 // Type or member is obsolete
    ...
    private void get_response_headers(cef_resource_handler_t* self, cef_response_t* response, long* response_length,
        cef_string_t* redirectUrl)
    {
        ...
        *response_length = m_responseLength;
        ...
        if (!string.IsNullOrEmpty(m_redirectUrl)) cef_string_t.Copy(m_redirectUrl, redirectUrl);
    }
    ...
    private int skip(cef_resource_handler_t* self, long bytes_to_skip, long* bytes_skipped,
    ...
    private int read(cef_resource_handler_t* self, void* data_out, int bytes_to_read, int* bytes_read,
    ...
    private int read_response(cef_resource_handler_t* self, void* data_out, int bytes_to_read, int* bytes_read,
        cef_callback_t* callback)
    {
        CheckSelf(self);
        ...
        using (var m_stream =
               new UnmanagedMemoryStream((byte*) data_out, bytes_to_read, bytes_to_read, FileAccess.Write))
        {
            int m_bytesRead;
#pragma warning disable CS0618 // Type or member is obsolete
