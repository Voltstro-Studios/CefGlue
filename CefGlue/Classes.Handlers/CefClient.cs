...
public abstract unsafe partial class CefClient
{
    ...
    /// </summary>
    protected virtual CefCommandHandler? GetCommandHandler()
    {
        return null;
    }
    ...
    private int on_process_message_received(cef_client_t* self, cef_browser_t* browser, cef_frame_t* frame,
        CefProcessId source_process, cef_process_message_t* message)
    {
        CheckSelf(self);
