...
public abstract unsafe partial class CefRequestContextHandler
{
    ...
    private int on_before_plugin_load(cef_request_context_handler_t* self, cef_string_t* mime_type,
        cef_string_t* plugin_url, int is_main_frame, cef_string_t* top_origin_url, cef_web_plugin_info_t* plugin_info,
        CefPluginPolicy* plugin_policy)
    {
        ...
        var result = OnBeforePluginLoad(mMimeType, mPluginUrl, mIsMainFrame, mTopOriginUrl, mPluginInfo,
            ref mPluginPolicy);
    ...
    /// </summary>
    protected virtual bool OnBeforePluginLoad(string? mimeType, string? pluginUrl, bool isMainFrame,
        string? topOriginUrl, CefWebPluginInfo pluginInfo, ref CefPluginPolicy pluginPolicy)
    {
        return false;
    }
