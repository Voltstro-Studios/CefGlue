...
public abstract unsafe partial class CefExtensionHandler
{
        ...
        cef_string_t* url, cef_client_t** client, cef_browser_settings_t* settings)
    {
        ...
        if (!cancel && o_client != m_client && m_client != null) *client = m_client.ToNative();
    ...
    /// </summary>
    protected virtual bool OnBeforeBackgroundBrowser(CefExtension extension, string? url, ref CefClient? client,
        ...
        cef_client_t** client, cef_browser_settings_t* settings)
    {
        ...
        var o_client = m_client;
        var cancel = OnBeforeBrowser(m_extension, m_browser, m_activeBrowser, index, m_url, m_active, m_windowInfo,
            ref m_client, m_settings);
    ...
    protected virtual bool OnBeforeBrowser(CefExtension extension, CefBrowser? browser, CefBrowser? activeBrowser,
        int index, string? url, bool active, CefWindowInfo windowInfo, ref CefClient? client,
        CefBrowserSettings settings)
    {
        return false;
    }
    ...
    private cef_browser_t* get_active_browser(cef_extension_handler_t* self, cef_extension_t* extension,
        cef_browser_t* browser, int include_incognito)
    {
        CheckSelf(self);
    ...
    /// </summary>
    protected virtual bool CanAccessBrowser(CefExtension extension, CefBrowser? browser, bool includeIncognito,
        CefBrowser? targetBrowser)
    {
        return true;
    }


    private int get_extension_resource(cef_extension_handler_t* self, cef_extension_t* extension,
    ...
    /// </summary>
    protected virtual bool GetExtensionResource(CefExtension extension, CefBrowser? browser, string? file,
        CefGetExtensionResourceCallback? callback)
    {
        return false;
    }
}