...
public abstract unsafe partial class CefDownloadHandler
{
    ...
    private void on_download_updated(cef_download_handler_t* self, cef_browser_t* browser,
    ...
    ///     this method.
    /// </summary>
    protected virtual void OnDownloadUpdated(CefBrowser browser, CefDownloadItem downloadItem,
