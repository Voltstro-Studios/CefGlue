...
public sealed unsafe partial class CefMenuModel
{
    ...
    /// </summary>
    public bool IsSubMenu => cef_menu_model_t.is_sub_menu(_self) != 0;

    /// <summary>
    ///     Returns the number of items in this menu.
    /// </summary>
    public int Count => cef_menu_model_t.get_count(_self);
    ...
    ///     true on success.
    /// </summary>
    public bool GetAccelerator(int commandId, out int keyCode, out bool shiftPressed, out bool ctrlPressed,
        out bool altPressed)
    {
        int n_keyCode;
        int n_shiftPressed;
        ...
        var result =
            cef_menu_model_t.get_accelerator(_self, commandId, &n_keyCode, &n_shiftPressed, &n_ctrlPressed,
                &n_altPressed) != 0;
    ...
    ///     on success.
    /// </summary>
    public bool GetAcceleratorAt(int index, out int keyCode, out bool shiftPressed, out bool ctrlPressed,
        out bool altPressed)
    {
        int n_keyCode;
        int n_shiftPressed;
        ...
        var result =
            cef_menu_model_t.get_accelerator_at(_self, index, &n_keyCode, &n_shiftPressed, &n_ctrlPressed,
                &n_altPressed) != 0;
