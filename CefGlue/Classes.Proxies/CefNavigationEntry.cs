...
public sealed unsafe partial class CefNavigationEntry
{
    ...
    /// </summary>
    public bool IsValid => cef_navigation_entry_t.is_valid(_self) != 0;
    ...
    /// </summary>
    public CefTransitionType TransitionType => cef_navigation_entry_t.get_transition_type(_self);

    /// <summary>
    ///     Returns true if this navigation includes post data.
    /// </summary>
    public bool HasPostData => cef_navigation_entry_t.has_post_data(_self) != 0;
    ...
    /// </summary>
    public int HttpStatusCode => cef_navigation_entry_t.get_http_status_code(_self);
