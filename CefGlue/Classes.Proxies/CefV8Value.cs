...
public sealed unsafe partial class CefV8Value
{
    ...
    ///     reference.
    /// </summary>
    public static CefV8Value CreateArrayBuffer(IntPtr buffer, ulong length,
        CefV8ArrayBufferReleaseCallback releaseCallback)
    {
    ...
    /// </summary>
    public bool SetValue(string? key, CefV8AccessControl settings,
    ...
    {
        return cef_v8value_t.set_user_data(_self,
            userData != null ? (cef_base_ref_counted_t*) userData.ToNative() : null) != 0;
    }
    ...
    private static cef_v8value_t*[]? CreateArguments(CefV8Value[]? arguments)
    {
        ...
        for (var i = 0; i < length; i++) result[i] = arguments[i].ToNative();
